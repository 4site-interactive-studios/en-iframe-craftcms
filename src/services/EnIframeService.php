...
class EnIframeService extends Component
{
    ...
    {
        try {
            $code = "<iframe loading='lazy' width='100%' scrolling='no' class='en-iframe ' data-src='$url' frameborder='0' allowfullscreen='' style='display:none' allow='autoplay; encrypted-media'></iframe>";
